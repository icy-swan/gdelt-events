use  "/Users/ianli/Desktop/stata工作/20221117/E13B 合入控制变量2007-2021 X与研发投入28961 2.dta",clear
* 构建回归所需的主要观测值
xtset firm year
...
forvalues i = 1/`maxNum' {
	...
	// 进行二次回归
	reghdfe FC指数 l.A l.ROA l.liability l.size `cv', absorb( industry province firm year) vce(clu firm)
