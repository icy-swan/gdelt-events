...
fs.createReadStream(path.resolve(__dirname, 'node', '1216', 'input', '2021.csv'))
    ...
    .on('end', (rowCount) => {
        fs.writeFile(path.resolve(__dirname, 'node', '1216', 'output', 'originData.json'), JSON.stringify(originData), 'utf8', function (err) {
            if (err) {
