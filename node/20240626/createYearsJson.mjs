...
fs.createReadStream(path.resolve(__dirname, 'node', '20240626', 'yearsum.csv'))
    ...
    .on('end', (rowCount) => {
        fs.writeFile(path.resolve(__dirname, 'node', '20240626', 'yearOriginData.json'), JSON.stringify(originData), 'utf8', function (err) {
            if (err) {
